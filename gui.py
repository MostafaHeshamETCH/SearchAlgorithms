...
root.title("Search Graph Algorithms - ASU Final AI Course Project")

Label(root, text="From Node", font=("Montserrat", 12), fg='#666666').grid(column=1, row=0, padx=2)
Label(root, text="To Node", font=("Montserrat", 12), fg='#666666').grid(column=2, row=0, padx=2)
Label(root, text="Weight", font=("Montserrat", 12), fg='#666666').grid(column=3, row=0, padx=2)

fromNodeField = Entry(root, width=5, justify="center", bg='#f0f0f0')
fromNodeField.grid(column=1, row=1, padx=2)
toNodeField = Entry(root, width=5, justify="center", bg='#f0f0f0')
toNodeField.grid(column=2, row=1, padx=2)
weightField = Entry(root, width=5, justify="center", bg='#f0f0f0')
weightField.grid(column=3, row=1, padx=2)
addEdgeBtn = Button(root, text="Add Edge", width=18, height=2, command=addEdgeToGraph, font=("Montserrat", 10))
addEdgeBtn.grid(column=5, row=1, columnspan=3)

divider1 = Label(root, text="")

Label(root, text="Node", font=("Montserrat", 12), fg='#666666').grid(column=1, row=2, padx=2)
Label(root, text="Heuristics", font=("Montserrat", 12), fg='#666666').grid(column=2, row=2, padx=2)

NodeField = Entry(root, width=5, justify="center", bg='#f0f0f0')
NodeField.grid(column=1, row=3, padx=2)
HeuristicValueField = Entry(root, width=5, justify="center", bg='#f0f0f0')
HeuristicValueField.grid(column=2, row=3, padx=2)
addHeuristicBtn = Button(root, text="Add Heuristics", width=18, height=2, command=lambda: addHeuristic(), font=("Montserrat", 10))
addHeuristicBtn.grid(column=5, row=3, columnspan=3)

Label(root, text="Start", font=("Montserrat", 12), fg='#666666').grid(column=1, row=4, padx=2)
Label(root, text="Goal/s", font=("Montserrat", 12), fg='#666666').grid(column=2, row=4, padx=2)

startField = Entry(root, width=5, justify="center", bg='#f0f0f0')
startField.grid(column=1, row=5, padx=2)
goalField = Entry(root, width=5, justify="center", bg='#f0f0f0')
goalField.grid(column=2, row=5, padx=2)
addStartAndGoal = Button(root, text="Add Start and Goal/s", width=18, height=3, command=lambda: addGoalNode(), font=("Montserrat", 10)).grid(column=5, row=5, columnspan=3)

Label(root, text="Directed", font=("Montserrat", 12), fg='#666666').grid(column=1, row=6, padx=2)
Button(root, text="BFS", width=7, height=2, command=lambda: bfsDirected(), font=("Montserrat", 12)).grid(column=1, row=7)
Button(root, text="DFS", width=7, height=2, command=lambda: dfs_directed(), font=("Montserrat", 12)).grid(column=2, row=7, padx=2)
Button(root, text="UCS", width=7, height=2, command=lambda: ucs_directed(), font=("Montserrat", 12)).grid(column=3, row=7, padx=2)
Button(root, text="Greedy", width=7, height=2, command=lambda: greedy_directed(), font=("Montserrat", 12)).grid(column=4, row=7, padx=2)
Button(root, text="A*", width=7, height=2, command=lambda: a_star_directed(), font=("Montserrat", 12)).grid(column=5, row=7, padx=2)
Button(root, text="Draw", width=7, height=2, command=lambda: drawDiGraph(), font=("Montserrat", 12)).grid(column=6, row=7, padx=2)

Label(root, text="Un-directed", font=("Montserrat", 12), fg='#666666').grid(column=1, row=8, padx=2)
Button(root, text="BFS", width=7, height=2, command=lambda: bfs(), font=("Montserrat", 12)).grid(column=1, row=9)
Button(root, text="DFS", width=7, height=2, command=lambda: dfs(), font=("Montserrat", 12)).grid(column=2, row=9, padx=2)
Button(root, text="UCS", width=7, height=2, command=lambda: ucs(), font=("Montserrat", 12)).grid(column=3, row=9, padx=2)
Button(root, text="Greedy", width=7, height=2, command=lambda: greedy(), font=("Montserrat", 12)).grid(column=4, row=9, padx=2)
Button(root, text="A*", width=7, height=2, command=lambda: a_star(), font=("Montserrat", 12)).grid(column=5, row=9, padx=2)
Button(root, text="Draw", width=7, height=2, command=lambda: drawGraph(), font=("Montserrat", 12)).grid(column=6, row=9, padx=2)

Button(root, text="Reset", width=30, height=2, command=lambda: reset(), font=("Montserrat", 12)).grid(column=3, row=10, padx=2, columnspan=4)
Button(root, text="Default", width=15, height=2, command=lambda: default(), font=("Montserrat", 12)).grid(column=1, row=10, padx=2, columnspan=2)
...
console = Label(root, text="Console data here", font=("Montserrat", 14), fg='#666666', bg='#f1f0f0', width=50, height=2)
console.grid(column=0, row=11, padx=2)
